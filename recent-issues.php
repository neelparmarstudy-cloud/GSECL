...
<head>
    ...
    <title>GSEC Daily Work Logbook - Recent Issues</title>
...
<body>
    <div class="container">
        ...
        <div class="main-content">
            <div class="content">
                <h2 class="section-title">Pending Issues In Instrument</h2>
                ...
                <div class="tab-container">
                    <div class="tab-nav">
                        ...
                        <button class="tab-btn active">Pending Issues</button>
                    ...
                    <div class="tab-content active">
                        <table class="data-table">
                            ...
                            <tbody>
                                <?php
                                $sql = "SELECT IssueID, InstrumentName, IssueDescription, Severity, ReportedDate, Status FROM instrumentissues WHERE Status IN ('Faulty')";
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td>" . htmlspecialchars($row["ReportedDate"]) . "</td>";
                                        echo "<td>" . htmlspecialchars($row["Status"]) . "</td>";
                                        echo "</tr>";
                                    }
                                } else {
                                    echo "<tr><td colspan='7'>No pending or faulty issues found.</td></tr>";
                                }
